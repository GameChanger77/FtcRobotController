...
public class OdometryTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while(move.collisionManager.genericAvoid(target) && opModeIsActive()){
                telemetry.update();
                if (move.withinTarget(target, 2)) break;
            }
...
//                        obstaclePose = move.collisionManager.genericAvoidPose(ob, target, 18);
//
