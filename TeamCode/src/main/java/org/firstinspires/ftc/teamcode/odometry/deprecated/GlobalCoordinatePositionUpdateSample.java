package org.firstinspires.ftc.teamcode.odometry.deprecated;
...
import org.firstinspires.ftc.teamcode.submodules.Chassis;
...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    final double COUNTS_PER_INCH = Constants.COUNTS_PER_INCH;

    //Hardware map names for the encoder wheels. Again, these will change for each robot and need to be updated below
    String rfName = Chassis.configNames[1], rbName = Chassis.configNames[3], lfName = Chassis.configNames[0], lbName = Chassis.configNames[2];
    String verticalLeftEncoderName = rbName, verticalRightEncoderName = lfName, horizontalEncoderName = rfName;

    /*
    vertical left encoder = port 3
    vertical right encoder = port 0
    horizontal encoder = port 1
     */
